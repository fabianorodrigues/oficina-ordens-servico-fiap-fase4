...
$contracts = @{
  ...
  'oficina-ordens-servico-fiap-fase4' = @{ Ci = 'Ordens CI'; Manuals = @{ 'Ordens Deploy' = 'DEPLOY'; 'AWS E2E Validate' = 'VALIDATE' } }
  'oficina-auth-lambda-fiap-fase4' = @{ Ci = 'Auth CI'; Manuals = @{ 'Auth Deploy' = 'DEPLOY' } }
  'oficina-infra-db-fiap-fase4' = @{ Ci = 'Database Infrastructure CI'; Manuals = @{ 'Database Infrastructure Deploy' = 'APPLY'; 'Database Bootstrap Deploy' = 'BOOTSTRAP' } }
  'oficina-infra-fiap-fase4' = @{ Ci = 'Platform CI'; Manuals = @{ 'Platform Deploy' = 'APPLY'; 'Entrypoint Deploy' = 'APPLY' } }
}
